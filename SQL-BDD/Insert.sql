...
('Pascal', 'Dupont', '1945-04-17', 'Phone book', 'pascal.dupont@gmail.com', '1234', '30 avenue des Champs-Elysee, Paris 75000, France'),
...
('Léa', 'Soutil', '1983-01-23', 'Word of mouth', 'lea.soutil@sfr.fr', '#Ma1234', 'Cayenne, Guyane'),
('Huges', 'Dupuit', '2012-06-30', 'Doctor', 'huges.dupuit@hotmail.fr', '1234', NULL);
...
(1, '2020-04-17 14:00:00', 'Credit Card'),
(2, '2019-08-17 14:30:00', 'Cash'),
(3, '2020-01-05 08:00:00', 'Cheque'),
...
(1, 1, 'Doesn\'t stand straight', NULL, 'Not straight', 5),
(2, 2, 'Slumped', 'Empty glance, seems destroyed in the inside', 'Lethargic', 5),
(3, 4, NULL, 'Always moving its hands, doesn\'t stop talking', 'Overexcited', 7),
